...
-- SET hivevar:upperFileName=DIM_M_CAMPAIGN;
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_campaign_ext (
    country_id   int,
    month_id     string,
    campaign_id  string,
    campaign_des string
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_campaign (
    country_id   int,
    month_id     string,
    campaign_id  string,
    campaign_des string
...
-------------------------------------------------------------------------------
ALTER TABLE gbic_dq_dim_m_campaign_ext
...
-------------------------------------------------------------------------------
INSERT OVERWRITE TABLE gbic_dq_dim_m_campaign
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    campaign_id,
    campaign_des
FROM gbic_dq_dim_m_campaign_ext
