...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_traffic_data_ext (
    country_id                   int,
    month_id                     int,
    billing_cycle_dt             int,
...
CREATE TABLE IF NOT EXISTS gbic_dq_traffic_data (
    country_id                   int,
    month_id                     int,
    billing_cycle_dt             int,
    billing_cycle_id             string,
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_billing_cycle_for_trafficdata_ext (
    country_id                   string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_billing_cycle_for_trafficdata (
    country_id                   string,
    billing_cycle_month          string,
    billing_cycle_id             string,
    billing_cycle_des            string,
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_m_lines_for_trafficdata_ext (
    country_id                   string,
    month_id                     string,
    msisdn_id                    string,
    subscription_id              string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_m_lines_for_trafficdata (
    country_id                   string,
    month_id                     string,
    msisdn_id                    string,
    subscription_id              string,
...
-------------------------------------------------------------------------------
INSERT OVERWRITE TABLE gbic_dq_traffic_data
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    mb_4g_qt,
    mb_roaming
FROM gbic_dq_traffic_data_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
  AND month_id IS NOT NULL;

INSERT OVERWRITE TABLE gbic_dq_dim_m_billing_cycle_for_trafficdata
PARTITION (
    gbic_op_id = ${gbic_op_id}
) SELECT
    country_id,
    ...
    billing_due_dt,
    billing_rv_computes
FROM gbic_dq_dim_m_billing_cycle_for_trafficdata_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND upper(country_id) != 'COUNTRY_ID';

INSERT OVERWRITE TABLE gbic_dq_m_lines_for_trafficdata
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month      = '${nominalTime}'
) SELECT
    ...
    total_rv,
    bta_ind
FROM gbic_dq_m_lines_for_trafficdata_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
