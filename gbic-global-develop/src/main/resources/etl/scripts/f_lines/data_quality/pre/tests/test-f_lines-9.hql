-------------------------------------------------------------------------------
--- VALIDATE IF RECORDS IN F_LINES MATCHING WITH CONDITION:
--- total_month_rv-(voice_month_rv+tv_month_rv+bband_month_rv)
-------------------------------------------------------------------------------
--- 
--- Description: Test if records in f_lines join with bband_tariff_plan
--- Parameters:
--- 
---     gbic_op_id:  Country internal identification
---     fileName:    Name of the processed file. 'f_lines' in this case
---     nominalTime: Date of the file in format YYYY-mm-dd
---     test_id:     9 in this case
-------------------------------------------------------------------------------
...
---   VARIABLES SETUP     ---
-----------------------------
SET hivevar:screenId=8;
-- SET hivevar:gbic_op_id=1;
-- SET hivevar:fileName=f_lines;
-- SET hivevar:nominalTime=2015-10-01;
-- SET hivevar:test_id=9;
