...
ALTER TABLE gbic_dq_customer_for_flines
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_postal_for_flines
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_f_tariff_plan_for_flines
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_segments_for_flines
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
