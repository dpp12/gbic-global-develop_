...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_m_line_services_ext (
    country_id                   int,
    month_id                     string,
    msisdn_id                    string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_m_line_services (
    country_id                   int,
    month_id                     string,
    msisdn_id                    string,
    subscription_id              string,
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_services_for_mlineservices_ext (
    country_id                   int,
    month_id                     string,
    id_service                   string,
    des_service                  string
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_services_for_mlineservices (
    country_id                   int,
    month_id                     string,
    id_service                   string,
    des_service                  string
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_group_sva_for_mlineservices_ext (
    country_id                   int,
    month_id                     string,
    group_sva                    string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_group_sva_for_mlineservices (
    country_id                   int,
    month_id                     string,
    group_sva                    string,
    group_sva_des                string
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_m_lines_for_mlineservices_ext (
    country_id                   string,
    month_id                     string,
    msisdn_id                    string,
    subscription_id              string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_m_lines_for_mlineservices (
    country_id                   string,
    month_id                     string,
    msisdn_id                    string,
    subscription_id              string,
...
-------------------------------------------------------------------------------
INSERT OVERWRITE TABLE gbic_dq_m_line_services
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    service_activ_dt,
    recurrent_ind
FROM gbic_dq_m_line_services_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
  AND upper(month_id) != 'MONTH_ID';

INSERT OVERWRITE TABLE gbic_dq_dim_m_services_for_mlineservices
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    id_service,
    des_service
FROM gbic_dq_dim_m_services_for_mlineservices_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
  AND upper(month_id) != 'MONTH_ID';

INSERT OVERWRITE TABLE gbic_dq_dim_m_group_sva_for_mlineservices
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    group_sva,
    group_sva_des
FROM gbic_dq_dim_m_group_sva_for_mlineservices_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
  AND upper(month_id) != 'MONTH_ID';

INSERT OVERWRITE TABLE gbic_dq_m_lines_for_mlineservices
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month      = '${nominalTime}'
) SELECT
    ...
    total_rv,
    bta_ind
FROM gbic_dq_m_lines_for_mlineservices_ext
WHERE gbic_op_id = ${gbic_op_id}
  AND month = '${nominalTime}'
  AND upper(month_id) != 'MONTH_ID';
