...
ALTER TABLE gbic_dq_customer_for_movements
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_m_movement_for_movements
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_m_tariff_plan_for_movements
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_segments_for_movements
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
