...
-- SET hivevar:upperFileName=DIM_M_GROUP_SVA;
...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_group_sva_ext (
    country_id                   int,
    month_id                     string,
    group_sva                    string,
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_group_sva (
    country_id                   int,
    month_id                     string,
    group_sva                    string,
    group_sva_des                string
...
-------------------------------------------------------------------------------
ALTER TABLE gbic_dq_dim_m_group_sva_ext
...
-------------------------------------------------------------------------------
INSERT OVERWRITE TABLE gbic_dq_dim_m_group_sva
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    group_sva,
    group_sva_des
FROM gbic_dq_dim_m_group_sva_ext
