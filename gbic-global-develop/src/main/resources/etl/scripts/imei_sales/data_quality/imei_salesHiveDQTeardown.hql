...
-- Drop orc partition
-------------------------------------------------------------------------------
ALTER TABLE gbic_dq_imei_sales
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_postal_for_imeisales
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_segments_for_imeisales
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_m_tariff_plan_for_imeisales
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
