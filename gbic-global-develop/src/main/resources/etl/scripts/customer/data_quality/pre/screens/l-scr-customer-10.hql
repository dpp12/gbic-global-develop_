-------------------------------------------------------------------------------
--- # DISTINCT CUSTOMER_ID PER GENDER_TYPE_CD
-------------------------------------------------------------------------------
--- 
--- Description: Gets the number of records in customer file per gender_type_cd
--- Parameters:
--- 
...
SELECT
    'gender_type_cd'                           AS field,
    gender_type_cd                             AS fieldContent,
