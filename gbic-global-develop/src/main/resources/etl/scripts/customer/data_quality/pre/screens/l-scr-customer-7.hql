-------------------------------------------------------------------------------
--- # DISTINCT CUSTOMER_ID PER PARTY_IDENTIFICATION_TYPE_CD
-------------------------------------------------------------------------------
--- 
...
SELECT
    'party_identification_type_cd'             AS field,
    party_identification_type_cd               AS fieldContent,
...
GROUP BY party_identification_type_cd;
