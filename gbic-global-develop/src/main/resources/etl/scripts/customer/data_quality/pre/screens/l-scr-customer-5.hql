-------------------------------------------------------------------------------
--- # DISTINCT CUSTOMER_ID WITH PARTY_IDENTIFICATION_NUM = -1
-------------------------------------------------------------------------------
--- 
--- Description: Gets the number of records in customer file with
---              party_identification_num = -1
--- Parameters:
--- 
...
WHERE party_identification_num = '-1'
