...
CREATE EXTERNAL TABLE IF NOT EXISTS gbic_dq_dim_m_tariff_plan_ext (
    country_id                   int,
    month_id                     string,
    tariff_plan_id               string,
    des_plan                     string,
    data_tariff_ind              int
) COMMENT 'External table over dim_m_tariff_plan raw files'
PARTITIONED BY (
    gbic_op_id                   int,
    month                        string
...
CREATE TABLE IF NOT EXISTS gbic_dq_dim_m_tariff_plan (
    country_id                   int,
    month_id                     string,
    tariff_plan_id               string,
    des_plan                     string,
    data_tariff_ind              int
) COMMENT 'ORC table over dim_m_tariff_plan raw files'
PARTITIONED BY (
    gbic_op_id                   int,
    month                        string
) ROW FORMAT DELIMITED
...
-------------------------------------------------------------------------------
ALTER TABLE gbic_dq_dim_m_tariff_plan_ext
...
-------------------------------------------------------------------------------
INSERT OVERWRITE TABLE gbic_dq_dim_m_tariff_plan
PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
) SELECT
    ...
    des_plan,
    data_tariff_ind
FROM gbic_dq_dim_m_tariff_plan_ext
