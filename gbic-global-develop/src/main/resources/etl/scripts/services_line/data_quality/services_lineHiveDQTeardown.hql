...
-- Drop orc partition
-------------------------------------------------------------------------------
ALTER TABLE gbic_dq_services_line
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_m_services_for_servicesline
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_dim_m_group_sva_for_servicesline
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
...
ALTER TABLE gbic_dq_m_lines_for_servicesline
DROP IF EXISTS PARTITION (
    gbic_op_id = ${gbic_op_id},
    month = '${nominalTime}'
);
