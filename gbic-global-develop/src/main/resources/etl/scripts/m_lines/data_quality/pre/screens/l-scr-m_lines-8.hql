-------------------------------------------------------------------------------
--- # RECORDS PER PRE_POST_ID
-------------------------------------------------------------------------------
--- 
--- Description: Gets the number of records per pre_post_id in m_lines file
--- Parameters:
--- 
...
SELECT
    'pre_post_id'                              AS field,
    pre_post_id                                AS fieldContent,
    count(*)                                   AS fieldValue,
