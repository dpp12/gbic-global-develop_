...
in_data = LOAD '/user/gplatform/inbox/bra/CUSTOMER/month=2015-01-01/CUSTOMER-2015-01-01.csv'
...
in_data_join = LOAD '/user/gplatform/inbox/bra/DIM_CUSTOMER/month=2015-01-01/DIM_CUSTOMER-2015-01-01.csv'
    USING org.apache.pig.piggybank.storage.CSVExcelStorage('|','YES_MULTILINE')
    AS (id_cli_:          long,
