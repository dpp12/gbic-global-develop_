...
in_data = LOAD '/user/gplatform/inbox/{chl}/MSv5/DIM_F_VOICE_TYPE/month=2015-01-01/*'
    USING PigStorage('|')
    AS (country_id:     int,
        month_id:       chararray,
...
STORE store_data INTO 'GBIC_GLOBAL.GBIC_GLOBAL_DIM_F_VOICE_TYPE'
