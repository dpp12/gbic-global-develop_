...
in_data = LOAD '/user/gplatform/inbox/{esp}/MSv5/TRAFFIC_DATA/month=2015-01-01/*'
    USING PigStorage('|')
    AS (country_id:             int,
        month_id:               chararray,
...
STORE store_data INTO 'GBIC_GLOBAL.GBIC_GLOBAL_TRAFFIC_DATA'
